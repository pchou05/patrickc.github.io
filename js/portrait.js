 ...
 * Handles the interactive portrait reveal effect
 */

export function initPortraitReveal(containerId, revealCanvasId, revealImageSrc) {
    const portraitContainer = document.getElementById(containerId);
    const revealCanvas = document.getElementById(revealCanvasId);
    const revealCtx = revealCanvas.getContext('2d');
    
    // Load the reveal image
    const revealImg = new Image();
    revealImg.src = revealImageSrc;
